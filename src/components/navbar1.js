        ...
        <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
          <nav className="navbar1-links1">
            <a href={props.link1Url}>
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar1-text16 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link2Url}>
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar1-text15 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link3Url} target="_blank" rel="noreferrer noopener">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar1-text18 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link4Url} target="_blank" rel="noreferrer noopener">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar1-text17 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            </a>
            <a href={props.link5Url} target="_blank" rel="noreferrer noopener">
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar1-text19 thq-body-small thq-link">
                    Link5
                  </span>
                </Fragment>
              )}
          ...
          <div className="navbar1-buttons1">
            <button className="navbar1-action11 thq-button-filled thq-button-animated">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar1-text20">Default value</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar1-action21 thq-button-outline thq-button-animated">
              <span className="thq-body-small">
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar1-text14">Default value</span>
                  </Fragment>
                )}
              </span>
            </button>
