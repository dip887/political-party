...
const Navbar6 = (props) => {
  ...
  return (
    <header className={`navbar6-container1 ${props.rootClassName} `}>
      <header data-thq="thq-navbar" className="navbar6-navbar-interactive">
              ...
              <div className="navbar6-menu-item1">
                ...
                <div className="navbar6-content1">
                  <span>
                    {props.page1 ?? (
                      <Fragment>
                        <span className="navbar6-text12 thq-body-large">
                          Page One
                        </span>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.page1Description ?? (
                      <Fragment>
                        <span className="navbar6-text13 thq-body-small">
              ...
              <div className="navbar6-menu-item2">
                ...
                <div className="navbar6-content2">
                  <span>
                    {props.page2 ?? (
                      <Fragment>
                        <span className="navbar6-text20 thq-body-large">
                          Page Two
                        </span>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.page2Description ?? (
                      <Fragment>
                        <span className="navbar6-text22 thq-body-small">
                          Lorem ipsum dolor sit amet consectetur elit
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="navbar6-menu-item3">
                ...
                <div className="navbar6-content3">
                  <span>
                    {props.page3 ?? (
                      <Fragment>
                        <span className="navbar6-text19 thq-body-large">
                          Page Three
                        </span>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.page3Description ?? (
                      <Fragment>
                        <span className="navbar6-text15 thq-body-small">
                          Lorem ipsum dolor sit amet consectetur elit
                        </span>
                      </Fragment>
                    )}
              ...
              <div className="navbar6-menu-item4">
                ...
                <div className="navbar6-content4">
                  <span>
                    {props.page4 ?? (
                      <Fragment>
                        <span className="navbar6-text18 thq-body-large">
                          Page Four
                        </span>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.page4Description ?? (
                      <Fragment>
                        <span className="navbar6-text10 thq-body-small">
                          Lorem ipsum dolor sit amet consectetur elit
                        </span>
                      </Fragment>
                    )}
        ...
        <div data-thq="thq-navbar-nav" className="navbar6-desktop-menu">
          <nav className="navbar6-links1">
            <a href={props.link1Url} className="navbar6-link11">
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar6-text21 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="navbar6-link21">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar6-text16 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            </a>
            <a href={props.link3Url} className="navbar6-link31">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar6-text11 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            </a>
            <a href={props.link4Url} className="navbar6-link41">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar6-text17 thq-body-small thq-link">
                    Default value
                  </span>
                </Fragment>
              )}
            ...
            >
              <span>
                {props.link5 ?? (
                  <Fragment>
                    <span className="navbar6-text14 thq-body-small thq-link">
                      Default value
                    </span>
                  </Fragment>
                )}
...
Navbar6.defaultProps = {
  page3ImageSrc:
    'https://images.unsplash.com/photo-1656574446871-02ec50c12b76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODk4MDIzOXw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1628838972052-1b9bc1538878?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODk4MDI0MHw&ixlib=rb-4.0.3&q=80&w=1080',
  page1: undefined,
  page1ImageAlt: 'image',
  rootClassName: '',
  ...
  page2: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1713637351063-32b07c355f85?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODk4MDI0MHw&ixlib=rb-4.0.3&q=80&w=1080',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1525017467541-995c08c663cc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyODk4MDI0MXw&ixlib=rb-4.0.3&q=80&w=1080',
