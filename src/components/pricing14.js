                      ...
                      {props.plan1Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text166 thq-body-small">
                            Access to all SPTV videos and podcasts
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text160 thq-body-small">
                            Stay updated with all news articles
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan2Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text206 thq-body-small">
                            Participate in live Q&amp;A sessions with our team
                          </span>
                        </Fragment>
                      )}
                    </span>
                      ...
                      {props.plan3Feature2 ?? (
                        <Fragment>
                          <span className="pricing14-text181 thq-body-small">
                            Personalized merchandise package
                          </span>
                        </Fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  <span>
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text165 thq-body-large">
                          Basic plan
                        </span>
                      </Fragment>
                    )}
